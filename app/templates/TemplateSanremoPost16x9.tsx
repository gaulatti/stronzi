/**
 * Sanremo Post 16x9 Template
 *
 * A 1920x1080 template for showcasing Sanremo artists.
 * 16:9 format (Landscape).
 */
...
export interface SanremoPost16x9Props {
  artistName: string;
...
export const defaultProps: SanremoPost16x9Props = {
...
export const fields: Array<FieldDef<SanremoPost16x9Props>> = [
  {
    key: 'artistName',
    label: 'Artist Name',
    type: 'text',
...
const TemplateSanremoPost16x9: React.FC<SanremoPost16x9Props> = (props) => {
      ...
      <div className='relative overflow-hidden' style={{ width: '1080px', height: '1080px' }}>
        ...
        <div className='relative z-10 h-full flex flex-col p-8'>
          ...
          <div className='flex-1 flex flex-col justify-center items-center space-y-6 mt-4'>
            ...
            {/* Artist image - 16:9 Aspect Ratio 
                Squared was 320x320. 
                16:9 matching height 320 -> width ~570.
            */}
            <div className='relative my-8'>
              ...
              <div className='relative bg-black/20 backdrop-blur-sm p-2.5 rounded-2xl border border-white/10'>
                <img src={artistImageUrl} alt={artistName} className='w-[461px] h-[259px] object-cover rounded-xl' crossOrigin='anonymous' />
              </div>
            </div>
...
export const templateDefinition: TemplateDefinition<SanremoPost16x9Props> = {
  id: 'sanremo_post_16x9',
  name: 'Sanremo Post 16x9',
  Component: TemplateSanremoPost16x9,
  defaultProps,
  fields,
  width: 1080,
  height: 1080,
...
export default TemplateSanremoPost16x9;
