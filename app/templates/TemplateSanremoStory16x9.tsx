/**
 * Sanremo Story 16x9 Template
 *
 * A 1080x1920 story template for showcasing Sanremo artists with 16x9 image.
...
export interface SanremoStory16x9Props {
  artistName: string;
...
export const defaultProps: SanremoStory16x9Props = {
...
export const fields: Array<FieldDef<SanremoStory16x9Props>> = [
  {
    key: 'artistName',
    label: 'Artist Name',
    type: 'text',
...
const TemplateSanremoStory16x9: React.FC<SanremoStory16x9Props> = (props) => {
      ...
      <div className='relative overflow-hidden pt-32' style={{ width: '1080px', height: '1920px' }}>
        ...
        <div className='relative z-10 h-full flex flex-col p-4'>
          ...
          <div className='flex-1 flex flex-col justify-center items-center space-y-10 -mt-5'>
            ...
            {/* Artist photo with decorative frame - 16x9 aspect ratio, reduced 20% */}
            <div className='relative my-8'>
              ...
              <div className='relative bg-black/20 backdrop-blur-sm p-2.5 rounded-2xl border border-white/10'>
                <img src={artistImageUrl} alt={artistName} className='w-[683px] h-[384px] object-cover rounded-xl' crossOrigin='anonymous' />
              </div>
            </div>
...
export const templateDefinition: TemplateDefinition<SanremoStory16x9Props> = {
  id: 'sanremo_story_16x9',
  name: 'Sanremo Story 16x9',
  Component: TemplateSanremoStory16x9,
  defaultProps,
  fields,
  width: 1080,
  height: 1920,
